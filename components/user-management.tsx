...
export function UserManagement({ profiles, isAdmin, canManagePermissions, canSendInvites }: { profiles: Profile[]; isAdmin: boolean; canManagePermissions: boolean; canSendInvites: boolean }) {
